...
Two record shapes live here:
  ...
  * :class:`NotifyResult` — the outcome of a :meth:`~bayleaf.notify.NotifyPort.notify`
...
class NotifyStatus(str, Enum):
    ...
    SENT = "sent"  # a real outbound post (Slack with BAYLEAF_SLACK_LIVE armed)
