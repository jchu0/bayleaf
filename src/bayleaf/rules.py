    ...
    return Finding(
        ...
        evidence=[
            Evidence(
                ...
                value=hit.clinvar_significance,  # VERBATIM CLNSIG — never bayleaf's determination
...
def evaluate_run(
    ...
    ``runbook`` may be a single :class:`~bayleaf.runbook.Runbook` — used AS-IS for every sample,
    the back-compat path, byte-identical to before — or a :class:`~bayleaf.runbook.RunbookSet`,
