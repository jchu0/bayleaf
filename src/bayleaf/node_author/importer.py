...
:class:`~bayleaf.node_author.NodeProposal` for a tool that need not be in the corpus.
...
The result is designed to pass :func:`~bayleaf.node_author.check_conformance` by construction.
"""
