...
:class:`~pathlib.Path` and returns it for the unchanged :func:`pipeguard.parsers.load_run`
to read. It is the default adapter (see :func:`pipeguard.artifacts.get_artifact_store`) and
...
_ENV_LOCAL_ROOT = "PIPEGUARD_ARTIFACT_LOCAL_ROOT"
...
class LocalArtifactStore:
    ...
    (e.g. from ``PIPEGUARD_ARTIFACT_LOCAL_ROOT``), a *relative* ``run_ref`` is resolved
