...
ingestion, EXEC-001/T-061), archivist (#3, T-059), and node-authoring (#5, T-046, 2026-07-10)** —
   ...
   11-entry curated tool-card corpus from a natural-language request, not a parser over a dropped
   tool's own docs — it can propose a tool already in the corpus, not onboard a genuinely new one.
