...
| Q30 (% bases ≥Q30) | fastp `summary.before_filtering.q30_rate` (**fraction**); MultiQC `after_filtering_q30_rate` | Vendor spec, read-length-dependent: NovaSeq ≥85% @2×50, **≥75% @2×150**; lab gate 80–85% | N (platform) | [Illumina Q30](https://knowledge.illumina.com/instrumentation/novaseq-6000/instrumentation-novaseq-6000-reference_material-list/000002669) |
